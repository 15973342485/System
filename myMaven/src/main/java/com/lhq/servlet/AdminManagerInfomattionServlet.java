...
@WebServlet(urlPatterns = "/AdminManagerInfomattionServlet")
@MultipartConfig
public class AdminManagerInfomattionServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if("search".equals(method)){
            ...
            StringBuffer sqlRow = new StringBuffer("select * from information ");
            //判断是否查询单个用户
            if(fid != null){
                sqlRow.append("where fid = " + fid + " ");
            }
            ...
            request.getRequestDispatcher("AdminManagerInfomation.jsp").forward(request,response);
